...
class MyDialog(QDialog):
    def __init__(self, title=None, msg=None, parent=None):
        ...
        # Stylesheet
        self.setStyleSheet("QDialog {background-color: qlineargradient( x1:0 y1:0, x2:1 y2:0, stop:0 #9acd32,  stop:1 #E2E2E2); } QLabel {color: #006400; font-size: 18px; font-weight: bold;}")
